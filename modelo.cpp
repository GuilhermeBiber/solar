...
void inicia_sistema_solar(CorpoCeleste *sol)
{
    ...
    sol->satelite[MERCURIO].raio_rotacao = 4879.40;
    ...
    sol->satelite[VENUS].raio_rotacao = 12103.60;
    ...
    sol->satelite[TERRA].raio_rotacao = 12756.20;
    ...
    sol->satelite[TERRA].satelite = (CorpoCeleste *)
        ...
        sol->satelite[TERRA].satelite[LUA].fr = 1.0 / 29.5;
        sol->satelite[TERRA].satelite[LUA].ft = 1.0 / 29.5;
        sol->satelite[TERRA].satelite[LUA].raio_translacao = 384400.00;
        sol->satelite[TERRA].satelite[LUA].raio_rotacao = 1700.00;
    ...
    sol->satelite[MARTE].ft = 1.0 / 686.0;
    sol->satelite[MARTE].raio_translacao = 227940000.00;
    sol->satelite[MARTE].raio_rotacao = 6794.40;
    ...
    sol->satelite[JUPITER].raio_translacao = 778330000.0;
    ...
    sol->satelite[SATURNO].raio_rotacao = 120536.00;
    ...
    sol->satelite[SATURNO].satelite = (CorpoCeleste *)
        ...
        sol->satelite[SATURNO].satelite[TITAN].raio_rotacao = 5100.00 * 2;
        ...
        sol->satelite[SATURNO].satelite[FEBE].raio_rotacao = 220.00 * 10;
        ...
        // os dados foram ajustados para melhor adaptar ao TP3
    ...
    sol->satelite[URANO].raio_rotacao = 51118.0;
    ...
    sol->satelite[NETUNO].raio_rotacao = 49538.0;
    ...
    sol->satelite[PLUTAO].raio_rotacao = 23200.0;
